...
import { LogOut, Shield, Trophy, LayoutDashboard, KeyRound, LogIn, UserPlus, BookOpen, CalendarDays, Gamepad2 } from "lucide-react";
...
const memberLinks = [
  ...
  { to: "/symulator", label: "Aktywność", icon: Gamepad2 },
  calendarLink,
  rulesLink,
];
